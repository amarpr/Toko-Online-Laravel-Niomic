			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												...
												<p>{{ $brg->harga }}</p>
												<?php if($id != null){?>
                                                    <button data-toggle="modal" data-target="#myModal{{$brg->id}}" data-id="{{ $brg->id }}" class="btn btn-default add-to-cart jumlah"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                                <?php }else{}?>
											</div>
										</div>
								</div>
                        ...
                        <!-- Modal -->
                    <div class="modal fade" id="myModal{{$brg->id}}" role="dialog">
